...
// City zones for town-vs-road leg classification. A leg is "town" only if it's short AND
// both ends sit in the same city zone (see estimate logic). Shared by client and server so
// the driver's estimate and the server's "route needs / cap" use the same basis.
export const ZONES = {
